...
SPACE_ID = "your-username/tiny-llm-template-playground"  # Replace with your HF username and repo
...
ASSET_COPIES = [
    (Path("assets/banner.png"), ASSETS_DIR / "banner.png"),
    (Path("assets/avatar.png"), ASSETS_DIR / "avatar.png"),
]
...
def main() -> None:
    ...
    api.upload_folder(
        ...
        repo_id=SPACE_ID,
        repo_type="space",
        commit_message="Update tiny-llm playground",
    )
